const CACHE = 'onecard-v8';
const ASSETS = ['./', './index.html', './style.css', './onecard-wallet.svg', './app.js', './import.js', './account.js', './config.js', './supabase-2.115.0.js', './manifest.webmanifest', './zxing-browser-0.1.5.min.js', './bwip-js-4.7.0.min.js'];
